...
<form method ="post"  action="ConfirmFacility.do">
    ...
    <div class="col-md-7">
        <%
            if((array!=null)&&(array.size()!=0))
            {
                out.println("<button class=\"btn add-btn\" style=\"float: right\">Submit</button> ");
            }
            else
            {
                out.println("<button class=\"btn add-btn\" style=\"float: right\"><a href=\"BookingFacility.jsp\">Go BAck</a></button>");
            }
